...
permalink: /docs/ibm-software/test-remote-ibmmq/
...
If you're one of us, click the button below to proceed.👇<br><br>
        👉<a href="https://pages.github.ibm.com/Miftah-Choiri/docs/ibm-software/test-remote-ibmmq/" class="btn btn--info btn--large"> Login W3@IBM </a>👈 
{: .notice--danger}
